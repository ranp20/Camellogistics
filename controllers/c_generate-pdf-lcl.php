...
require_once 'c_cifrasaletras.php';
	  ...
	  <div class="marc_fill" id="two_sectionlist">
	    <div id="marc_dat3">
	      ...
	      <div id="marc_dat3_der">
	        ...
	        <div class="item_demp3_dat1">FOB - <?php echo maxcharacters($f_origen, 32); ?></div>
	      ...
	      <div id="marc_dat3_derr1">
	        <div class="item_marc3_dat2">Seguro Internacional</div>
	        <?php 
	        	if($f_optgenfquotation == "not-moreOpts" && $f_selinsuremerch == "SI" && $f_fob != "" && $f_fob > 0){
	        		echo "<div class='item_marc3_dat2'>FOB</div>";
	        	}
	        ?>
	      </div>
	      <div id="marc_dat3_cent">
	        ...
	        <?php 
	        	if($f_optgenfquotation == "not-moreOpts" && $f_selinsuremerch == "SI" && $f_fob != "" && $f_fob > 0){
	        		echo "<div class='item_dpt3_dat1'>:</div>";
	        	}
	        ?>
	      </div>
      ...
      <div id="marc_det_fillcomplete">
	    ...
	    <div id="marc_det_er_log_unique">
          ...
          <div id="title_serv_first_uniquecamel" class="pt-07">
	          <div class="item_marc_det_serinf_serv1">Total Flete Internacional</div>
	        </div>
	        ...
	        <div id="ammount_serv_first_camel1" class="pt-07">
	          <div class="item_marc_tot_ser"><?php echo addTwoDecimalsOrGuion($f_total_services); ?></div>
	        </div>
	      </div>
	    </div>
	  </div>
	  <div class="marc_fill" id="five_sectionlist">
	    ...
	    <div class="marc_moreofone">
		    <div class="marc_medium">
		        ...
		        <div class="item_marc_det_serinf_serv1">I.G.V</div>
		      </div>
