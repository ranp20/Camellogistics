...
<!-- 	  <div class="marc_fill" id="four_sectionlist">
        ...
        <div id="cnt_img_money_camel1">
	      ...
	      <div id="ammount_serv_ulti_camel1">
	        <div class="item_marc_tot_ser1"><strong><?php echo addTwoDecimals($f_totalimpuestos); ?></strong></div>
	      </div>        
	    </div>
        ...
        <div id="cnt_img_money_camel2">
	      ...
	      <div id="ammount_serv_ulti_camel2">
	        <div class="item_marc_tot_ser1"><strong><?php echo addTwoDecimals($f_totalwithIGV); ?></strong></div>
	      </div>     
	    </div>
	  </div> -->
