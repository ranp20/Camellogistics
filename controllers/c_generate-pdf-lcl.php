	  ...
	  <div class="marc_fill" id="two_sectionlist">
	    <div id="marc_dat3">
	      ...
	      <div id="marc_dat3_der">
	        ...
	        <div class="item_demp3_dat1"><?php echo maxcharacters($u_contain, 28); ?></div>
	        <div class="item_demp3_dat1">FOB - <?php echo maxcharacters($f_origen, 28); ?></div>
	        <?php
	        	$txt_contquantity = "";
	        	if($f_quantity_prod != 0 && $f_quantity_prod != ""){
	        		$quant_prod = (intval($f_quantity_prod) > 1) ? $f_quantity_prod . " UNIDADES" : $f_quantity_prod . " UNIDAD";
	        		$txt_contquantity = $f_desc_weightvolumen ." / ". $quant_prod;
	        		echo "<div class='item_demp3_dat1'>".maxcharacters($txt_contquantity, 37)."</div>";
	        	}else{
	        		$txt_contquantity = $f_desc_weightvolumen;
	        		echo "<div class='item_demp3_dat1'>".maxcharacters($txt_contquantity, 37)."</div>";
	        	}
	        ?>
