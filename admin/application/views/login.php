...
<head>
    ...
    <title><?php echo $title; ?></title>
        <link rel="icon" href="<?php echo base_url( $this->config->item('favicon') ); ?>" type="image/jpg">
    ...
    <div class="wrapper" style="margin: 0 0 0 0">
        <div class="block-center mt-xl wd-xl">
            <div class="text-center" style="margin-bottom: 20px">
                <img style="width: 80%;"
                     src="<?= base_url() . $this->config->item('company_logo') ?>" class="m-r-sm">
            </div>
            <?= message_box('success'); ?>
            <?= message_box('error'); ?>
            ...
            <div class="panel panel-dark panel-flat left-login-panel">
                <div class="panel-heading text-center">
                   ...
                   <span style="font-size: 15px;"><?php echo $this->config->item('company_name') ; ?>
                    </a>
                </div>
                <?php if (!empty($type)) {
                    ?>
