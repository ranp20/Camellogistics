        ...
        <div class="col-sm-6 report" id="">
            <div class="panel report_menu">
                <div class="row row-table row-flush">
                    <?php
                    $data_lcl = $this->db->where(['vigencia_desde <= ' => $date, 'vigencia_hasta >= ' => $date])->get('tbl_aq_carga_lcl')->row();
                    $color = 'warning';
                    $text = '<i class="fa fa-warning"> </i> Tarifas Vencidas ';
                    $a = '<a href="' . base_url() . 'lcl/import" class="mt0 mb0 text-' . $color . '"> Subir Tarifas <i class="fa fa-arrow-circle-right"></i></a>';
                    if ($data_lcl) {
                        $color = 'success';
                        $text = '<i class="fa fa-check"></i> Tarifas Activas';
                        $a = '<a data-toggle="modal" data-target="#myModal_large"
                    title="VER DETALLE DE TARIFAS"
                    href="' . base_url() . 'lcl/tarifas/' . $data_lcl->carga_lcl_id . '"
                    class="mt0 mb0 text-' . $color . '"> Ver detalle <i class="fa fa-arrow-circle-right"></i></a>';
                    }
                    ?>
                    <div class="col-xs-6 bb br">
                        <div class="row row-table row-flush">
                            <div class="col-xs-2 text-center text-<?= $color ?>">
                                <em class="fa fa-dollar fa-2x"></em>
                            </div>
                            <div class="col-xs-10">
                                <div class="text-center">
                                    <h4 class="mt-sm mb0 text-<?= $color ?>">
                                        <?php
                                        echo 'TARIFAS LCL'
                                        ?>
                                    </h4>
                                    <h4 class="mt-sm mb0 text-<?= $color ?>">
                                        <?php
                                        echo ($data_lcl) ? $data_lcl->vigencia_desde . ' Al ' . $data_lcl->vigencia_hasta : '';
                                        ?>
                                    </h4>
                                    <p class="mb0 text-<?= $color?>"><?= $text ?></p>
                    ...
                    <?php
                    $data_fcl = $this->db->where(['vigencia_desde <= ' => $date, 'vigencia_hasta >= ' => $date])->get('tbl_aq_carga_fcl')->row();
                    $color = 'warning';
                    $text = '<i class="fa fa-warning"> </i> Tarifas Vencidas ';
                    $a = '<a href="' . base_url() . 'fcl/import" class="mt0 mb0 text-' . $color . '"> Subir Tarifas <i class="fa fa-arrow-circle-right"></i></a>';
                    if ($data_fcl) {
                        $color = 'success';
                        $text = 'Tarifas Activas';
                        $a = '<a data-toggle="modal" data-target="#myModal_large"
                    title="VER DETALLE DE TARIFAS"
                    href="' . base_url() . 'fcl/tarifas/' . $data_fcl->carga_fcl_id . '"
                    class="mt0 mb0"> Ver detalle <i class="fa fa-arrow-circle-right"></i></a>';
                    }
                    ?>
                        ...
                        <div class="row row-table row-flush">
                            ...
                            <div class="col-xs-10">
                                <div class="text-center">
                                    ...
                                    <h4 class="mt-sm mb0">
                                        <?php
                                        echo ($data_fcl) ? $data_fcl->vigencia_desde . ' Al ' . $data_fcl->vigencia_hasta : '';
                                        ?>
                                    </h4>
                                    <p class="mb0  text-<?= $color?>"><?= $text ?></p>
                                    <small><?php echo $a; ?></small>
