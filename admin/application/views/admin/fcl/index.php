...
<div class="panel panel-custom">
  <header class="panel-heading ">
    ...
    <a href="<?= base_url().'admin/fcl/import' ?>" class="btn btn-success"> Importar </a>
    </div>
    <div class="panel-title"><strong>TARIFAS FCL</strong></div>
  </header>
      ...
      <tbody>
        <script type="text/javascript">
          $(document).ready(function() {
            list = base_url + "admin/fcl/vigenciasList/";
