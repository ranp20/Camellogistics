...
<div class="panel panel-custom">
  <header class="panel-heading">
    <div class="panel-title"><strong><?= $title ?></strong>
      ...
      <div class="pull-right hidden-print">
        <div class="pull-right "><a href="<?php echo base_url() ?>assets/sample/TARIFAS_LCL_SAMPLE.xlsx" class="btn btn-primary"><i class="fa fa-download"> Descargar Archivo Ejemplo</i></a>
        </div>
      </div>
      </div>
  ...
  <div class="panel-body">
    <form role="form" enctype="multipart/form-data" id="form_import" action="<?php echo base_url(); ?>admin/lcl/save_imported" method="post" class="form-horizontal  ">
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2 input-group">
            <input type="text" name="utilidad" class="form-control" placeholder="15" required>
