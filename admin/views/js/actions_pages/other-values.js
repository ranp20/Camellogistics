...
$(document).on("keyup keypress","input[data-valformat='twodecimal']",function(e){
...
$(document).on("keyup keypress", "input[data-valformat=withcomedecimal]", function(e){
  let val = e.target.value;
      ...
      if(r.length == 0){
        ...
        $.each(r, function(i,e){
          ...
          if(e.id == 1){
            ...
            tmp_dataformatinput = "onlyintegers";
            tmp += `
              <tr id="item-${e.id}">
                <td>
                  <div class="cont-dashCamel__cControlsList--cC--cTable--cControl">
                    ...
                    <div class="cont-dashCamel__cControlsList--cC--cTable--cControl--cInputs mx-longlabel">
                      <input type="text" data-valformat='onlyintegers' id="" name="" placeholder="0.00" class="cont-dashCamel__cControlsList--cC--cTable--cControl--cInputs--input" value="${e.data_value}">
                    </div>
                  </div>
                </td>
              </tr>`;
