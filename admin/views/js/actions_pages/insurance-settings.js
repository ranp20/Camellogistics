          ...
          <td>
            <div class="cont-dashCamel__cControlsList--cC--cTable--cControl">
              <label for="" class="cont-dashCamel__cControlsList--cC--cTable--cControl--label">
                <a class="btn-update-insurancevalues" href="javascript:void(0);" data-toggle="modal" data-target="#updateModal" 
                   data-id="${e.id}"
...
$(document).on('click', '#btnupdate-insurancevalues', function(e){
  e.preventDefault();
