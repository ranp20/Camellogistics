...
<body>
			...
			<div class="cont-dashCamel">
				<div class="box-window-border">
					...
					<div class="contain-table-responsive">
						<table id="tbl_utilities_rate_lcl" class="cont-dashCamel__list-results" cellpadding="0" width="100%">
							<thead>
								<tr>
	...
	<script type="text/javascript" src="<?= $url ?>js/actions_pages/rate_lcl.js"></script>
</body>
</html>