...
<body>
			...
			<div class="cont-dashCamel">
				<div class="box-window-border">
					<div class="cont-dashCamel__addtitle">
						<h2 class="cont-dashCamel__addtitle--title">Configuración de precios - FCL</h2>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="update-modal-label">ACTUALIZAR PRECIOS</h5>
					      ...
					      <div class="modal-body cont-total-update-items">
					      	<div class="cont-modalbootstrapupdate">
						        <form id="form-update-quotationvalues" method="POST" class="cont-modalbootstrapupdate__form" autocomplete="false">
						        	...
						        	<div class="cont-modalbootstrapupdate__form--control">
						        		<label for="datavalueprov-update" class="cont-modalbootstrapupdate__form--control__label complete">Precio del Valor - Proveedor</label>
						        		<input id="datavalueprov-update" class="cont-modalbootstrapupdate__form--control__input" name="datavalueprov-update" type="number" maxlength="300" placeholder="Ingrese el precio del valor del proveedor">
						        	</div>
	...
	<script type="text/javascript" src="<?= $url;?>js/actions_pages/pricing-settings-fcl.js"></script>
</body>
</html>