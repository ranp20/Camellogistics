...
<body>
			...
			<div class="cont-dashCamel">
				<div class="box-window-border">
					<div class="cont-dashCamel__addtitle">
						<h2 class="cont-dashCamel__addtitle--title">Configuración de precios - LCL</h2>
	...
	<script src="<?= $url ?>js/actions_pages/pricing-settings-lcl.js"></script>
</body>
</html>