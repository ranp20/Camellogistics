...
<body>
					      	...
					      	<div class="cont-modalbootstrapupdate">
						        <form id="form-update-merchandisevalues" method="POST" class="cont-modalbootstrapupdate__form" autocomplete="false">
						        	...
						        	<div class="cont-modalbootstrapupdate__form--control">
						        		<label for="dataname-update" class="cont-modalbootstrapupdate__form--control__label complete">Nombre</label>
						        	...
						        	<div class="cont-modalbootstrapupdate__form--control">
						        		<label for="datavalue-update" class="cont-modalbootstrapupdate__form--control__label complete">Valor</label>
						        		<input id="datavalue-update" class="cont-modalbootstrapupdate__form--control__input" name="datavalue-update" type="text" data-valformat="withcomedecimal" maxlength="300" placeholder="Ingrese el precio del seguro">
						        	</div>
	...
	<script type="text/javascript" src="<?= $url ?>js/actions_pages/merchandise-settings.js"></script>
</body>
</html>