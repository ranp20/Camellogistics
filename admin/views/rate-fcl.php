			...
			<div class="cont-dashCamel">
				<div class="box-window-border">
					<div class="cont-dashCamel__addtitle">
						<h2 class="cont-dashCamel__addtitle--title">TARIFAS FCL</h2>
						<button type="button" href="#" id="add-spreadsheetfcl" class="cont-dashCamel__addtitle--btn-add" data-toggle="modal" data-target="#addspreadsheetfclModal">
					...
					<div class="contain-table-responsive">
						<table id="tbl_utilities_rate_fcl" class="cont-dashCamel__list-results" cellpadding="0" width="100%">
							<thead>
								<tr>
