...
class Update_Product extends Connection{
	function update(){
		$arr_product = [
			...
			"id_regulatorone" => (isset($_POST['id_regulatorone']) && $_POST['id_regulatorone'] != "") ? $_POST['id_regulatorone'] : 0,
			"id_regulator_two" => (isset($_POST['id_regulatortwo']) && $_POST['id_regulatortwo'] != "") ? $_POST['id_regulatortwo'] : 0,
		...
		try{
			$sql = "CALL sp_update_product(:name, :sel_regulated, :sel_taxadditional, :sel_fichatecycertconform, :id_regulatorone, :id_regulator_two, :ad_valoren, :impuesto_selectivo, :antidumping, :fichacert_min, :fichacert_max, :fichacert_quantity, :id)";
