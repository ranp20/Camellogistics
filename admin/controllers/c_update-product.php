...
class Update_Product extends Connection{
	function update(){
		...
		try{
			$sql = "CALL sp_update_product(:name, :sel_regulated, :sel_ammadditional, :sel_taxadditional, :id_regulator, :id_regulator_two, :amount_additional, :ad_valoren, :impuesto_selectivo, :antidumping, :id)";
