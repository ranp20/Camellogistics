...
class Add_Products extends Connection{	
	function add(){
		...
		try{
			$sql = "CALL sp_add_product(:name, :sel_regulated, :sel_ammadditional, :sel_taxadditional, :sel_fichatecycertconform, :id_regulator, :id_regulator_two, :amount_additional, :ad_valoren, :impuesto_selectivo, :antidumping, :fichatecycertconform)";
