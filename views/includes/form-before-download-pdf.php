		...
		<div class="cnt-modalFormLoginyRegister--c--cForm">
			<form id="btngen_formDataUserQuotation" method="POST">
				<div class="cnt-modalFormLoginyRegister--c--cForm--cControl">
					...
					<input type="text" id="n_document_cli" name="n_document_cli" class="cnt-modalFormLoginyRegister--c--cForm--cControl--input" placeholder="Ingrese el número de documento" maxlength="11" required>
				...
				<div class="cnt-modalFormLoginyRegister--c--cForm--cControl">
					...
					<input type="text" id="name_enterprise_cli" name="name_enterprise_cli" class="cnt-modalFormLoginyRegister--c--cForm--cControl--input" placeholder="Ingrese el nombre de la empresa" maxlength="50" required>
				...
				<div class="cnt-modalFormLoginyRegister--c--cForm--cControl">
					...
					<input type="number" id="telephone_cli" name="telephone_cli" class="cnt-modalFormLoginyRegister--c--cForm--cControl--input" placeholder="Ingrese el número de teléfono" maxlength="11" required>
				...
				<div class="cnt-modalFormLoginyRegister--c--cForm--cControl">
					...
					<input type="email" id="email_cli" name="email_cli" class="cnt-modalFormLoginyRegister--c--cForm--cControl--input" placeholder="Ingrese el correo electrónico" maxlength="50" required>
