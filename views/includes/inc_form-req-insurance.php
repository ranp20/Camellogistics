		...
		<div class="cnt-modalFormReqInsurance--c--cForm" id="f-formResolModalNotInsurance">
			<div class="cnt-modalFormReqInsurance--c--cForm--cControl">
				...
				<div class="cnt-modalFormReqInsurance--c--cForm--cControl--cListChangeWIcon">
					...
					<input type="text" id="v_valtoreqinsurance" name="v_valtoreqinsurance" data-valformat="withcomedecimal" class="cnt-modalFormReqInsurance--c--cForm--cControl--cListChangeWIcon--input" placeholder="Ingresa el valor del FOB" maxlength="13" autocomplete="off">
				</div>
