				...
				<div class="box-container">
					...
					<div class="c-CalculatorStep--form--contStep--cStepSelects">
						...
						<div class="c-CalculatorStep--form--contStep--cStepSelects--item">
							...
							<input type="text" placeholder="ESCRIBA País, Ciudad o Puerto" id="input-vallistorigin" autocomplete="off" maxlength="150">
						...
						<div class="c-CalculatorStep--form--contStep--cStepSelects--item">
							...
							<input type="text" placeholder="País, Ciudad o Puerto" id="input-vallistdestiny" autocomplete="off" maxlength="150">
