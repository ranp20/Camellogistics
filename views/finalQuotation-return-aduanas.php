...
<input tabindex="-1" placeholder="" type="hidden" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v-plcpickuprateprov" value="<?= (isset($_POST['plc-pickuprate']) && $_POST['plc-pickuprate'] != "") ? $_POST['plc-pickuprate'] : 0;?>">
...
<input tabindex="-1" placeholder="" type="hidden" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_floadTypeTranport" value="<?= (isset($_POST['loadTypeTranport']) && $_POST['loadTypeTranport'] != "") ? $_POST['loadTypeTranport'] : "No seleccionado";?>">
<input tabindex="-1" placeholder="" type="hidden" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_ftotalfleteprod" value="<?= (isset($_POST['val_valfleteprod']) && $_POST['val_valfleteprod'] != "") ? $_POST['val_valfleteprod'] : 0;?>">
</div>
</div>
  <?php
