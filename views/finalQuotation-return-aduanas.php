...
<input tabindex="-1" placeholder="" type="hidden" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v-plcpickuprateprov" value="<?php echo $_POST['plc-pickuprate'];?>">
...
<input tabindex="-1" placeholder="" type="hidden" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_floadTypeTranport" value="<?= (isset($_POST['loadTypeTranport']) && $_POST['loadTypeTranport'] != "") ? $_POST['loadTypeTranport'] : 0;?>">
