...
<div>
<div>
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_typeserviceinit" value="<?php echo $_POST['val-typeoptselectininit'];?>">
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_datevaliddesde" value="<?= (isset($_POST['val-datevaliddesde']) && $_POST['val-datevaliddesde'] != "") ? $_POST['val-datevaliddesde'] : 0;?>">
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_datevalidhasta" value="<?= (isset($_POST['val-datevalidhasta']) && $_POST['val-datevalidhasta'] != "") ? $_POST['val-datevalidhasta'] : 0;?>">
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_idgencoderand" value="<?php echo $_POST['ipt-vidcodgenrand'];?>">
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_loadtypecharge" value="<?php echo $_POST['loadTypeCharge'];?>">
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v-plcpickuprateprov" value="<?php echo $_POST['plc-pickuprate'];?>">
<input tabindex="-1" placeholder="" type="text" width="0" height="0" autocomplete="off" spellcheck="false" f-hidden="aria-hidden" class="non-visvalipt h-alternative-shwnon s-fkeynone-step" id="v_typetranspsendinitid" value="<?php echo $_POST['idtypetransportsendinit'];?>">
