...
//print_r($_POST);
 ...
 $sql = "SELECT * from tbl_cotizacion_lcl_detail lcl
            inner join tbl_aq_carga_lcl_detail aq1 on aq1.carga_lcl_detail_id=lcl.carga_lcl_detail_id where lcl.lcl_detail_id='$id'";
